            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="about_img" class="form-control" type="file" id="image" value="{{ $aboutpage->about_img }}">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                        ...
                        <img id="showImage" class="rounded avatar-lg" src="{{ 
                           (!empty($aboutpage->about_img))? url( $aboutpage->about_img):url('upload/no_image.jpg') }}" alt="Card image cap">
                        </div>
                    </div>
                    <!-- end row -->
